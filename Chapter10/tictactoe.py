...
def isWinner(bo, le):
	...
	(bo[1] == le and bo[2] == le and bo[3] == le) or # Bot
...
def getComputerMove(board, computerLetter):
	...
	#Check if the player could win and block them
	for i in range(1, 10):
		boardCopy = getBoardCopy(board)
		if isSpaceFree(boardCopy, i):
...
# Main
print('Let\'s play SOME FUCKING TIC-TAC-TOE')
