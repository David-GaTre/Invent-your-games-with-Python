...
def drawBoard(board):
    ...
    tensDigitsLine = '     ' # Initial space for the numbers down the left side
    for i in range(1, 6):
        if i == 1:
            tensDigitsLine += (' ' * 8) + str(i)
        else:
...
def getRandomChests(numChests):
    # Create a list of chest data structures (two-item lists of x, y in coord.)
    chests = []
...
def makeMove(board, chests, x, y):
    ...
    for cx, cy in chests:
        ...
        if distance < smallestDistance: # We want the closes treasure chest.
    ...
    if smallestDistance == 0:
        ...
        if smallestDistance < 10:
            ...
            board[x][y] = 'X'
            return 'Sonar did not detect anything. All chests are out of range.'

def enterPlayerMove(previousMoves):
    # Let the player enter their move. Should be 2 integers representing coordinates.
    ...
    while True:
        ...
        print('Enter a nmber from 0 to 59, a space and then a numer from 0 to 14.')
...
while True:
    ...
    while sonarDevices > 0:
        ...
        previousMoves.append([x, y]) # We must track all moves so that sonar devices update
    ...
    if sonarDevices == 0:
        ...
        print('home with the treasure chests still out there! Game over.')
